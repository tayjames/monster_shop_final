...
RSpec.describe 'Admin Dashboard' do
  describe 'As an Admin' do
    before :each do
      ...
      @home = @m_user.addresses.create!(street: "1111 Ash St.", city: "Denver", state: "CO", zip: "80220")
      ...
      @order_1 = @m_user.orders.create!(address: @home, status: "packaged")
      @order_2 = @m_user.orders.create!(address: @home, status: "pending")
      @order_3 = @m_user.orders.create!(address: @home, status: "cancelled")
